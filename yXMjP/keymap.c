...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [SYMB] = LAYOUT_moonlander(
    QK_REBOOT, KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_F6,                                          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_AMPR,        KC_TRANSPARENT,                                                                 EURO_SIGN,     KC_DOT,         DUAL_FUNC_5,    DUAL_FUNC_6,    DUAL_FUNC_7,    KC_ASTR,        KC_MINUS,       
  ...
  [UTIL] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 SM_POWR,SM_SLEP,QK_DEBUG_TOGGLE, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, QK_BOOT,        
  ...
  [STEN] = LAYOUT_moonlander(
    ...
    S(ALT_TAB),          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          ALT_TAB,          
...
const uint16_t PROGMEM combo0[] = { KC_Q, KC_J, MT(MOD_LSFT, KC_E), LT(SYMB, KC_O), COMBO_END};
...
const uint16_t PROGMEM combo7[] = { KC_SCLN, KC_Q, MT(MOD_LSFT, KC_E), KC_J, LT(SYMB, KC_O), MT(MOD_LALT, KC_A), COMBO_END};
...
const uint16_t PROGMEM combo16[] = { KC_Q, KC_J, MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), COMBO_END};
const uint16_t PROGMEM combo17[] = { MT(MOD_LSFT, KC_E), KC_W, KC_V, LT(SYMB, KC_O), COMBO_END};
...
const uint16_t PROGMEM combo22[] = { KC_SPACE, MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), COMBO_END};
...
const uint16_t PROGMEM combo27[] = { MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), COMBO_END};
const uint16_t PROGMEM combo28[] = { KC_M, KC_W, KC_V, COMBO_END};
const uint16_t PROGMEM combo29[] = { MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), LT(NAVI, KC_ENTER), COMBO_END};
const uint16_t PROGMEM combo30[] = { KC_M, KC_W, KC_V, LT(NAVI, KC_ENTER), COMBO_END};
const uint16_t PROGMEM combo31[] = { KC_SPACE, MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), LT(NAVI, KC_ENTER), COMBO_END};
...
const uint16_t PROGMEM combo36[] = { LT(SYMB, KC_N), KC_V, MT(MOD_RSFT, KC_T), KC_W, COMBO_END};
...
const uint16_t PROGMEM combo41[] = { MT(MOD_RCTL, KC_H), KC_M, KC_V, LT(SYMB, KC_N), COMBO_END};
const uint16_t PROGMEM combo42[] = { KC_M, KC_W, MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), COMBO_END};
...
const uint16_t PROGMEM combo47[] = { KC_M, MT(MOD_RCTL, KC_H), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), KC_V, KC_W, COMBO_END};
...
const uint16_t PROGMEM combo50[] = { LT(SYMB, KC_O), MT(MOD_LSFT, KC_E), MT(MOD_RSFT, KC_T), LT(SYMB, KC_N), COMBO_END};
...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(combo50, DOT_SPAC),
    COMBO(combo51, COMA_SPAC),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  ...
  case QK_MODS ... QK_MODS_MAX:
    ...
    case SM_POWR:
    if (record->event.pressed) {
      SEND_STRING(SS_LGUI("x") SS_DELAY(100)"u"SS_DELAY(100)"u");
    }
    break;
    case SM_SLEP:
    if (record->event.pressed) {
      SEND_STRING(SS_LGUI("x")SS_DELAY(100)"u"SS_DELAY(100)"s");
    }
    break;
    case ALT_TAB:
    if (record->event.pressed) {
